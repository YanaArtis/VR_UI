...
// TODO: Implement VRUI_Button.SetStateImage().
...
//		btnShowMainMenu.SetOnOutDelegate (OnButtonOutDelegate);
		btnShowMainMenu.SetOnActivatedDelegate (OnButtonShowMainMenu);

		btnShowTourMenu = testMenu.FindById ("btnTourMenu") as VRUI_Button;
//		btnShowTourMenu.SetOnOverDelegate (OnButtonOverDelegate);
//		btnShowTourMenu.SetOnOutDelegate (OnButtonOutDelegate);
...
//		subContainer.Add (text);
	...
	public void OnButtonOutDelegate (string buttonId) {
		Debug.Log ("Button OUT: \""+buttonId+"\"");
	}

	public void OnButtonActivatedDelegate (string buttonId) {
		Debug.Log ("Button ACTIVATED: \""+buttonId+"\"");
	}
	*/
